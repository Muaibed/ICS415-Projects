...
public class ShaderManager {
    ...
    public void setUniform(String unformName, Vector4f value) {
        GL20.glUniform4f(uniforms.get(unformName), value.x, value.y, value.z, value.w);
    }

    public void setUniform(String unformName, Vector3f value) {
        GL20.glUniform3f(uniforms.get(unformName), value.x, value.y, value.z);
    }

    private void setUniform(String uniformName, boolean value) {
        float res = 0;
        if (value)
            res = 1;
